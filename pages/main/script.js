...
const moduleCards = document.querySelector('.wrapper-slider1');
...
let newArray = getRandomPets(); // newArray-рандомный массив карточек получен
...
// попап
btnLeft.addEventListener("click", createElemList);
btnRight.addEventListener("click", createElemList);
